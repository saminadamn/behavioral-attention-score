...
FEATURE_DEFINITIONS: tuple[FeatureDefinition, ...] = (
    ...
    FeatureDefinition("session_dominant_attention_state", FeatureCategory.TARGET, "str", "Most frequent attention state across the session — a session-level aggregate computed FROM attention_state across the same rows; leaks the target if used as model input, excluded by default."),
    ...
    FeatureDefinition("prompt_text", FeatureCategory.PROMPT, "text", "The prompt's rendered text."),
    ...
    FeatureDefinition("prompt_keywords", FeatureCategory.PROMPT, "text", "Prompt's domain keywords, '|'-joined."),
    FeatureDefinition("prompt_learning_objective", FeatureCategory.PROMPT, "text", "The topic's learning objective sentence."),
    ...
    # Response
    FeatureDefinition("response_text", FeatureCategory.RESPONSE, "text", "The generated student response text."),
    ...
    FeatureDefinition("response_hesitation_markers", FeatureCategory.RESPONSE, "text", "Detected hesitation phrases, '|'-joined."),
    ...
    FeatureDefinition("response_strategy_used", FeatureCategory.TARGET, "str", "Which `ResponseStrategy` class generated this response — bijective with attention_state by construction (FocusedStrategy<->Focused, etc.); leaks the target if used as model input, excluded by default."),
    # Behaviour
